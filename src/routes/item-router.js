...
itemRouter.post('/admin/add-item', isAdmin, uploadItemImage, itemController.createItem);
itemRouter.get('/list', itemController.getItem);
itemRouter.put('/admin/update-item/:itemId', isAdmin, uploadItemImage, itemController.updateItem);
